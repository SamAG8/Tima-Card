...
gcloud builds submit \
  --config "/Users/hosseinasgari/Developer/Time Clock/cloudbuild_admin.yaml" \
  ...
  "/Users/hosseinasgari/Developer/Time Clock/timeclock-admin"
